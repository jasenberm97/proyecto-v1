...
<section class="content">
    <div class="d-flex justify-content-center mt-4">
        <div class="card col-sm-8 p-3">
            ...
            <div class="mb-2">
                <form action="{{ route('create_course') }}" method="POST" class="row g-3 form-asig" id="form-asig" autocomplete="off">
                @csrf
                    <div class="col-md-12 form-boxA">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-select perfil-select" name="name_faculty" value="{{ old('name_faculty') }}" required>
                                <option value="" selected>Selecciona facultad</option>
                    ...
                    <div class="col-lg-12 form-boxA">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-select perfil-select" name="semester" value="{{ old('semester') }}" required>
                                <option value="" selected>Selecciona semestre</option>
                    ...
                    <button type="button" class="btn btn-primary btn-lg" id="submit-btn-asig" disabled>GUARDAR</button>
