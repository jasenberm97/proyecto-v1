    ...
    if (boxSelect?.name) {
        boxSelect.addEventListener('change', function(){
            ...
            timeout = setTimeout(() => {
                ...
                validation(box, boxInput, boxSelect)
            }, 500);
        })
    }
...
submitController = () => {
    if (errors.name || errors.last_name || errors.identification || errors.username || errors.email || errors.rol || errors.password || errors.password_confirmation) {
